...
<h1>svelte-box playground</h1>

<p>Five live demos. Each page focuses on one container so the behavior is easy to read.</p>
...
<section>
    ...
    <p>
        ...
        the page shows <code>clone</code>, <code>box.toConst()</code>, and <code>isBox</code>.
    </p>
</section>
